...
class MetaDatasetReader(object):
    def __init__(self, mode, train_set, validation_set, test_set, gin_file_name='meta_dataset_config.gin'):
        ...
        self.test_set_dict = {}
        self.specs_dict = {}
        gin.parse_config_file(f"{PROJECT_ROOT}/data/{gin_file_name}")
...
class MetaDatasetEpisodeReader(MetaDatasetReader):
    ...
    """
    def __init__(self, mode, train_set=None, validation_set=None, test_set=None, test_type='standard', image_size=84, gin_file_name='meta_dataset_config.gin'):
        super(MetaDatasetEpisodeReader, self).__init__(mode, train_set, validation_set, test_set, gin_file_name)
        self.mode = mode
    ...
    def _get_task(self, next_task, session):
        #next_episode = next_task.get_next()
...
class MetaDatasetBatchReader(MetaDatasetReader):
    ...
    Class that wraps the Meta-Dataset episode readers.
    """
    def __init__(self, mode, train_set, validation_set, test_set, batch_size, image_size=84, gin_file_name='meta_dataset_config.gin'):
        super(MetaDatasetBatchReader, self).__init__(mode, train_set, validation_set, test_set, gin_file_name)
